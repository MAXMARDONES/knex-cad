...
var out=fs.readFileSync("viewer/01_head.html","utf8")+body+fs.readFileSync("viewer/03_scene.js","utf8")+fs.readFileSync("viewer/03b_parts.js","utf8")+fs.readFileSync("viewer/04_build.js","utf8")+fs.readFileSync("viewer/08_stress.js","utf8")+fs.readFileSync("viewer/09_steps.js","utf8")+fs.readFileSync("viewer/06_physics.js","utf8")+fs.readFileSync("viewer/05_ui.js","utf8")+fs.readFileSync("viewer/11_drag.js","utf8")+fs.readFileSync("viewer/10_params.js","utf8")+fs.readFileSync("viewer/07_physui.js","utf8");
